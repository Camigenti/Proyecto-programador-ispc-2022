...
#MODIFICACION NECESARIA PARA REALIZAR EL EJERCICIO

INSERT INTO `historial` (`ID_Historial`, `Fecha`, `Perro`, `Descripción`, `Monto`) VALUES
(6, '2022-07-15', 1, 'Baño', '800');

#EJERCICIO NUMERO 7: Obtener los ingresos percibidos en Julio del 2022


SELECT `Monto` as 'Ingresos Julio 2022' FROM `historial` where `Fecha` > '2022-06-30' AND `Fecha` < '2022-08-01';
